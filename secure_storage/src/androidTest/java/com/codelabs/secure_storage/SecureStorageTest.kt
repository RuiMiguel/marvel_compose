...
import com.codelabs.secure_storage.exception.StorageException
...
class SecureStorageTest() {
    ...
    fun readPrivateKeyThrowsReadExceptionWhenStorageFails(): Unit = runTest {
        try {
            testDataStore.edit { preferences ->
                preferences[booleanPreferencesKey(SecureStorage.CredentialsKeys.PRIVATE_KEY.name)] =
                    true
            }
    ...
    fun readPublicKeyThrowsReadExceptionWhenStorageFails(): Unit = runTest {
        try {
            testDataStore.edit { preferences ->
                preferences[booleanPreferencesKey(SecureStorage.CredentialsKeys.PUBLIC_KEY.name)] =
                    true
            }
    ...
    fun saveCredentialsSucceeded(): Unit = runTest {
        ...
        val privateKey =
            testDataStore.data.first().toPreferences()[SecureStorage.CredentialsKeys.PRIVATE_KEY]
        val publicKey =
            testDataStore.data.first().toPreferences()[SecureStorage.CredentialsKeys.PUBLIC_KEY]
