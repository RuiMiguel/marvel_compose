package com.example.verygoodcore.marvel_compose.stories.view
...
fun StoriesPage() {
    Row(modifier = Modifier
        ...
        Column(modifier = Modifier
            ...
            Text(text = stringResource(R.string.menu_stories), style = Typography.body1)
